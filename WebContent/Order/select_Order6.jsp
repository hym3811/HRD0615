...
<%
	...
	Integer sumtotal=0;
	try{
		sql="select a.ordername,b.productid,b.name,sum(a.orderqty),sum(a.orderqty*a.unitprice) from order0614 a join product0614 b on a.productid=b.productid group by b.productid,b.name,a.ordername order by a.ordername,b.productid";
		pstmt=conn.prepareStatement(sql);
		rs=pstmt.executeQuery();
		while(rs.next()){
			no++;
			ordername=rs.getString(1);
